...
df=pd.read_csv("C:/Users/Shree/Desktop/Machine learning/spam.csv",encoding="latin-1")
...
#to check my target attribute is binary or not
np.unique(df['class'])
...
#create count trnsformer object
cv=CountVectorizer()
